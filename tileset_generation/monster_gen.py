...
MONSTERS = {
    ...
    14: {
        ...
        "tier": 1,
        "creature_type": "bird",
        "visual_desc": "a single dark crow-like bird in flight, wings spread wide, sleek black feathers with an oily sheen",
        "colors": "glossy black feathers, dark purple highlights, sharp yellow beak",
        "boss": False,
    },
    15: {
        "name": "Tanglethorn",
    ...
    17: {
        ...
        "tier": 1,
        "creature_type": "spider",
        "visual_desc": "a single pale-gray spider with translucent web-draped legs, silver-white body with visible dark vein patterns, spinning silk from spinnerets",
        "colors": "silver-gray body, dark gray leg joints, white silk threads, pale translucent web",
        "boss": False,
    },
    18: {
        "name": "Orc Scout",
        ...
        "visual_desc": "a single full-body orc scout crouching low, wiry green-skinned goblinoid with leather jerkin, holding a crude short bow, alert posture",
        "colors": "yellow-green skin, brown leather armor, crude wooden bow",
        "boss": False,
    },
    19: {
        "name": "Swamp Adder",
    ...
    36: {
        ...
        "tier": 2,
        "creature_type": "humanoid",
        "visual_desc": "a single full-body orc captain standing tall, heavy green-skinned orc in dark iron plate armor with a red plume helmet, holding a notched iron sword, muscular stance",
        "colors": "dark green skin, black iron armor, rust-red plume, iron sword",
        "boss": False,
    },
    37: {
        "name": "Warg Rider",
    ...
    56: {
        ...
        "tier": 3,
        "creature_type": "undead_humanoid",
        "visual_desc": "a gaunt wild-eyed prisoner in tattered rags, matted tangled hair, dragging broken chains, hollow expression of despair, emaciated frame hunched forward",
        "colors": "pale ashen skin, tattered gray rags, rusty iron chains, sunken dark eyes",
        "boss": False,
    },
    57: {
        ...
        "tier": 3,
        "creature_type": "humanoid",
        "visual_desc": "a single full-body Easterling warrior champion standing upright, gold and crimson lamellar armor, horned helm with face guard, holding a curved sword, proud martial stance",
        "colors": "gold-red layered armor, dark red cloak, steel curved blade, bronze horned helm",
        "boss": False,
    },
    58: {
        "name": "Ghast",
    ...
    59: {
        ...
        "tier": 3,
        "creature_type": "troll",
        "visual_desc": "a massive red-skinned troll dungeon warden wearing a heavy leather apron, carrying iron manacles and heavy keys in both hands, a bone-bead necklace, iron-capped teeth bared in a menacing grin",
        "colors": "deep red skin, dark leather apron, heavy iron implements, bone-bead necklace",
        "boss": True,
    },
    60: {
    ...
    73: {
        ...
        "tier": 3,
        "creature_type": "undead_humanoid",
        "visual_desc": "a shambling undead figure in tattered burial clothes, gray-green withered skin, arms outstretched reaching forward, milky pale eyes, slow and relentless shuffling gait",
        "colors": "gray-green withered skin, tattered brown burial rags, pale bone, milky white eyes",
        "boss": False,
    },
    80: {
    ...
    74: {
        ...
        "visual_desc": "a single ancient undead wight in tattered burial robes, pale blue glowing eyes, withered gray flesh, reaching forward with skeletal clawed hands, ethereal blue mist around feet",
        "colors": "pale blue glow, gray withered skin, tattered dark burial wrappings, ice-blue eyes",
        "boss": False,
    },
    75: {
        "name": "Corpse-candle",
    ...
    78: {
        ...
        "visual_desc": "a single massive construct built from fused bones and skulls, a towering humanoid made entirely of yellowed bones bound by dark sinew, skull for a head, bone-shard claws",
        "colors": "yellowed ancient bone, dark sinew bindings, hollow eye sockets, cracked ivory",
        "boss": False,
    },
    79: {
    ...
    82: {
        ...
        "tier": 4,
        "creature_type": "humanoid",
        "visual_desc": "a sorcerer in dark violet ceremonial robes covered in arcane sigils, tracing a glowing mystic circle in the air with one hand, holding an ornate dark dagger in the other, eyes glowing violet with dark power",
        "colors": "dark violet robes, glowing arcane sigils, obsidian dagger, violet glowing eyes",
        "boss": False,
    },
    83: {
    ...
    94: {
        ...
        "tier": 5,
        "creature_type": "spirit",
        "visual_desc": "a single dark wraith in flowing tattered black robes, hooded faceless figure with only two glowing red eyes visible, ghostly robes trailing into darkness, holding a spectral blade",
        "colors": "pitch black robes, glowing red eyes, spectral gray blade, dark wispy edges",
        "boss": False,
    },
    95: {
        "name": "Fell Spirit",
    ...
    98: {
        ...
        "tier": 5,
        "creature_type": "spirit",
        "visual_desc": "a single large ghostly horror, a massive pale translucent figure with an anguished expression, elongated jaw opened in an eternal scream, tattered spectral form, arms reaching forward",
        "colors": "pale translucent white, ghostly blue-white glow, dark hollow eyes and mouth, wispy edges",
        "boss": True,
    },
    99: {
    ...
    131: {
        ...
        "tier": 6,
        "creature_type": "troll",
        "visual_desc": "a single massive armored troll in crude dark iron plate armor, enormous hulking gray-skinned troll with tusks, wielding a huge spiked iron mace, heavy brow and small fierce eyes",
        "colors": "dark gray-green skin, crude black iron plate armor, rusted iron spikes, heavy chain",
        "boss": False,
    },
    136: {
