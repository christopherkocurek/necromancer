...
static flag_name info_flags[] = {
    ...
    { "CROSSBOW", RF4, RF4_CROSSBOW }, { "RF4XXX23", RF4, RF4_RF4XXX23 },
    ...
    { "SWORD_PROFICIENCY", RHF, RHF_SWORD_PROFICIENCY },
    ...
    { "LOR_AFFINITY", RHF, RHF_LOR_AFFINITY },
    { "LOR_PENALTY", RHF, RHF_LOR_PENALTY },
    { "SWORD_PROFICIENCY", RHF, RHF_SWORD_PROFICIENCY },
